...
import img from "../../../assets/Homepage_Images/HistoryImages/Frame 2 (2).png";
      ...
      <div className={styles.historyContent}>
        ...
        <div className={styles.our_history}>
          ...
          <p>
            ...
            excel in the rapidly evolving digital marketing landscape. Founded
            by LearnMarketer, a seasoned expert in digital marketing with over 7
